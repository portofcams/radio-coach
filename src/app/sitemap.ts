...
export default function sitemap(): MetadataRoute.Sitemap {
  const core = ['', '/train', '/practice', '/listen', '/oral', '/leaderboard', '/guides', '/glossary', '/blog', '/airspace', '/directory', '/written', '/flashcards', '/acs', '/brief', '/tools', '/metar', '/crosswind', '/density-altitude', '/e6b', '/airports', '/ground-school', '/cheatsheet', '/learn']
