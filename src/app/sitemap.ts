...
export default function sitemap(): MetadataRoute.Sitemap {
  const core = ['', '/train', '/practice', '/listen', '/oral', '/leaderboard', '/guides', '/glossary', '/blog', '/airspace', '/directory', '/written', '/flashcards', '/acs', '/brief', '/tools', '/metar', '/taf', '/go-no-go', '/notam', '/crosswind', '/density-altitude', '/takeoff-landing', '/e6b', '/compare', '/widgets', '/confidence', '/community', '/top-pilots', '/airports', '/ground-school', '/cheatsheet', '/learn']
  ...
  return [...core, ...legal, ...guides, ...blog, ...airspace, ...compare, ...states, ...airports]
}
