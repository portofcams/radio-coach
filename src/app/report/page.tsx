    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-8 py-10 text-gray-900">
        ...
        <p className="text-[11px] text-gray-400 mt-8 border-t border-gray-200 pt-3">
          Generated by Clearspar Radio Trainer (clearsparradio.binnacleai.com) on {today}. Scores reflect radio-communication readback practice and are not a certification.
        </p>
      </div>
    </main>
  )
